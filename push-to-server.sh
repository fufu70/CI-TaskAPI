...
COMMANDS[0]="sudo -S rm -rf TaskAPI"
COMMANDS[1]="git clone https://github.com/fufu70/TaskAPI.git"
COMMANDS[2]="sudo rsync -a TaskAPI/src/ /var/www/task_api/src/"
COMMANDS[3]="sudo rsync -a TaskAPI/vagrant/ install/"
COMMANDS[4]="sudo rsync -a TaskAPI/sql/ sql/"
COMMANDS[5]="sudo chown www-data:www-data -R /var/www/task_api"
